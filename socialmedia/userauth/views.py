...
from . models import  Followers, LikePost, Post, Profile, Aliado
...
def aliados(request):
    return render(request,'aliados.html')
def lista_aliados(request):
    aliados = Aliado.objects.all()
    return render(request, 'lista_aliados.html', {'aliados': aliados})
def registrar_aliado(request):
    if request.method == 'POST':
        nombre = request.POST.get('txtNombre')
        correo = request.POST.get('txtCorreo')
        oferta = request.POST.get('ofrezco')
        categoria = request.POST.get('categoria')
        telefono = request.POST.get('Telefono')
        imagen = request.FILES.get('imagenAliado')
        ...
        return render(request, 'registrar_aliado.html')